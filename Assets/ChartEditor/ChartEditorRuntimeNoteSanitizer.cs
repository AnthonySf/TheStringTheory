...
public static class ChartEditorRuntimeNoteSanitizer
{
    ...
    private static ChartEditorNote CloneNote(ChartEditorNote source)
    {
        return new ChartEditorNote
        {
            ...
            hasRuntimeMuted = source.hasRuntimeMuted,
            runtimeMuted = source.runtimeMuted,
            hasRuntimePalmMute = source.hasRuntimePalmMute,
            runtimePalmMute = source.runtimePalmMute,
