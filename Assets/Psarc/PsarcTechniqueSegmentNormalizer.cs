...
public static class PsarcTechniqueSegmentNormalizer
{
    public static List<NoteTechniqueSegmentData> BuildNormalizedTechniqueSegments(PsarcCachedNoteData source)
    {
        ...
        if (source?.techniqueSegments != null && source.techniqueSegments.Count > 0)
        {
            ...
            {
                PsarcCachedTechniqueSegmentData segment = source.techniqueSegments[segmentIndex];
                if (segment == null)
                    continue;
        ...
        return NormalizePsarcTechniqueSegments(source, segments);
    }

    private static List<NoteTechniqueSegmentData> NormalizePsarcTechniqueSegments(
        PsarcCachedNoteData source,
    ...
    private static List<NoteTechniqueSegmentData> BuildBendTechniqueSegmentsFromPoints(
        ...
        List<NoteTechniqueSegmentData> existingSegments)
    {
        List<PsarcCachedBendPointData> points = source.bendPoints
        ...
        PsarcCachedBendPointData firstPoint = points[0];
        ...
        PsarcCachedBendPointData lastPoint = points[points.Count - 1];
    ...
    private static float FindFirstBendPointOffsetAtOrAbove(
        IReadOnlyList<PsarcCachedBendPointData> points,
        float targetBend,
        float duration)
    {
        ...
        {
            PsarcCachedBendPointData point = points[i];
            if (point == null)
                continue;
